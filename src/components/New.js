...
function New(){
    return (
        ...
        <div class="text-start " style={{paddingLeft: 30, marginTop: 20, marginBottom: 30}}>
            <span>
        ...
        <div class="row text-start " style={{paddingLeft: 30}}>
            <div class="col-md-3">
                <h3>Tin tức - Sự kiện</h3>
                <ul class="list-unstyled">
                    <li class="my-1"><Link to="/news" class="text-decoration-none text-dark">Tin tức</Link></li>
                    <hr class="bg-secondary my-0" />
                    <li class="my-1"><Link to="#" class="text-decoration-none text-dark">- Thông báo</Link></li>
                    <hr class="bg-secondary my-0" />
                    <li class="my-1"><Link to="#" class="text-decoration-none text-dark">- Tin bài</Link></li>
                    <hr class="bg-secondary my-0" />
                    <li class="my-1"><Link to="/news" class="text-decoration-none text-dark">Sự kiện</Link></li>
                    <hr class="bg-secondary my-0" />
                    <li class="my-1"><Link to="#" class="text-decoration-none text-dark">- Sự kiện sắp diễn ra</Link></li>
                    <hr class="bg-secondary my-0" />
                    <li class="my-1"><Link to="#" class="text-decoration-none text-dark">- Sự kiện đã diễn ra</Link></li>
                    <hr class="bg-secondary my-0" />
                    <li class="my-1"><Link to="#" class="text-decoration-none text-dark">SoICT Talks</Link></li>
                </ul>
            </div>
            <div class="col-md-9">
                <div class="row">
                    <div class="col-md-12">
                        <img src={require("../img/bander.jpg")} class="w-100 mt-4" />
                    </div>
                    <div class="col-md-9 " style={{marginTop: 20}}>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card border-0 mb-4">
                                    <Link to="#"> <img src={require("../img/news1.jpg")} class="w-100" /></Link>
                                    <div class="card-body px-0">
                                        ...
                                        <p class=" mb-0" style={{color:'gray'}}>23 Tháng Năm, 2022</p>
                            ...
                            <div class="col-md-6">
                                <div class="card border-0 mb-4">
                                    <Link to="#"> <img src={require("../img/news2.jpg")} class="w-100" /></Link>
                                    <div class="card-body px-0">
                                        <Link to="#" class="text-dark text-decoration-none">
                                        ...
                                        <p class=" mb-0" style={{color:'gray'}}>19 Tháng Năm, 2022</p>
                            ...
                            <div class="col-md-6">
                                <div class="card border-0 mb-4">
                                    <Link to="#"> <img src={require("../img/news3.jpg")} class="w-100" /></Link>
                                    <div class="card-body px-0">
                                        <Link to="#" class="text-dark text-decoration-none">
                                        ...
                                        <p class=" mb-0" style={{color:'gray'}}>18 Tháng Năm, 2022</p>
                            ...
                            <div class="col-md-6">
                                <div class="card border-0 mb-4">
                                    <Link to="#"> <img src={require("../img/news4.jpg")} class="w-100" /></Link>
                                    <div class="card-body px-0">
                                        <Link to="#" class="text-dark text-decoration-none">
                                            <h6 class="card-title fw-bolder">HỘI NGHỊ SINH VIÊN NGHIÊN CỨU KHOA HỌC 2021-2022</h6>
                                        </Link>
                                        <p class=" mb-0" style={{color:'gray'}}>17 Tháng Năm, 2022</p>
                            ...
                            <div class="col-md-6">
                                <div class="card border-0 mb-4">
                                    <Link to="#"> <img src={require("../img/news5.jpg")} class="w-100" /></Link>
                                    <div class="card-body px-0">
                                        <Link to="#" class="text-dark text-decoration-none">
                                        ...
                                        <p class="mb-0" style={{color:'gray'}}>12 Tháng Năm, 2022</p>
                            ...
                            <div class="col-md-6">
                                <div class="card border-0 mb-4">
                                    <Link to="#"> <img src={require("../img/news6.jpg")} class="w-100" /></Link>
                                    <div class="card-body px-0">
                                        <Link to="#" class="text-dark text-decoration-none">
                                            <h6 class="card-title fw-bolder">THÔNG BÁO VỀ THỰC TẬP DOANH NGHIỆP KỲ 2021.3</h6>
                                        </Link>
                                        <p class=" mb-0" style={{color:'gray'}}>10 Tháng Năm, 2022</p>
                            ...
                            <div class="col-md-6">
                                <div class="card border-0 mb-4">
                                    <Link to="#"> <img src={require("../img/news7.jpg")} class="w-100" /></Link>
                                    <div class="card-body px-0">
                                        <Link to="#" class="text-dark text-decoration-none">
                                        ...
                                        <p class=" mb-0" style={{color:'gray'}}>3 Tháng Năm, 2022</p>
                            ...
                            <div class="col-md-6">
                                <div class="card border-0 mb-4">
                                    <Link to="#"> <img src={require("../img/news8.jpg")} class="w-100" /></Link>
                                    <div class="card-body px-0">
                                        <Link to="#" class="text-dark text-decoration-none">
                                        ...
                                        <p class=" mb-0" style={{color:'gray'}}>29 Tháng Tư, 2022</p>
                            ...
                            <div class="col-md-6">
                                <div class="card border-0 mb-4">
                                    <Link to="#"> <img src={require("../img/news9.jpg")} class="w-100" /></Link>
                                    <div class="card-body px-0">
                                        <Link to="#" class="text-dark text-decoration-none">
                                            <h6 class="card-title fw-bolder">VINGROUP KHỞI ĐỘNG KHÓA 2 – ĐỢT 2 CHƯƠNG TRÌNH ĐÀO TẠO KỸ SƯ AI</h6>
                                        </Link>
                                        <p class=" mb-0" style={{color:'gray'}}>27 Tháng Tư, 2022</p>
                            ...
                            <div class="col-md-6">
                                <div class="card border-0 mb-4">
                                    <Link to="#"> <img src={require("../img/news10.jpg")} class="w-100" /></Link>
                                    <div class="card-body px-0">
                                        <Link to="#" class="text-dark text-decoration-none">
                    ...
                    <div class="col-md-3">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-3"><Link to="#" class="text-dark text-decoration-none" style={{textTransform: 'uppercase'}}>THÔNG BÁO TUYỂN GIẢNG VIÊN NGÀNH CÔNG NGHỆ THÔNG TIN</Link></li>
                            <li class="mb-3"><Link to="#" class="text-dark text-decoration-none" style={{textTransform: 'uppercase'}}>INVITATION TO JOIN BK.AI RESEARCH GROUPS 2021</Link></li>
                            <li class="mb-3"><Link to="#" class="text-dark text-decoration-none" style={{textTransform: 'uppercase'}}>THÔNG BÁO VỀ ĐĂNG KÝ LỚP HỌC PHẦN THỰC TẬP DOANH NGHIỆP KỲ HÈ 2020.3</Link></li>
                            <li class="mb-3"><Link to="#" class="text-dark text-decoration-none" style={{textTransform: 'uppercase'}}>TĂNG CƯỜNG LỢI THẾ CẠNH TRANH DỰA TRÊN CÔNG NGHỆ SỐ, TẠO ĐỘT PHÁ TRONG MỌI MẶT HOẠT ĐỘNG</Link></li>
                            <li class="mb-3"><Link to="#" class="text-dark text-decoration-none" style={{textTransform: 'uppercase'}}>ĐẦU TƯ CHO NCKH VÀ ĐT TRÌNH ĐỘ CAO TRONG TRƯỜNG ĐẠI HỌC: ĐIỂM ĐỘT PHÁ TRONG QUÁ TRÌNH CHUYỂN ĐỔI SỐ TẠI VN</Link></li>
                            <li class="mb-3"><Link to="#" class="text-dark text-decoration-none" style={{textTransform: 'uppercase'}}>TUYỂN DỤNG 2020</Link></li>
                            <li class="mb-3"><Link to="#" class="text-dark text-decoration-none" style={{textTransform: 'uppercase'}}>SOICT YEAR-END REVIEW 2019</Link></li>
                            <li class="mb-3"><Link to="#" class="text-dark text-decoration-none" style={{textTransform: 'uppercase'}}>HỘI THẢO QUỐC TẾ THƯỜNG NIÊN SOICT - 10 NĂM MỘT CHẶNG ĐƯỜNG</Link></li>
                            <li class="mb-3"><Link to="#" class="text-dark text-decoration-none" style={{textTransform: 'uppercase'}}>HUST-SOICT'S TALK, SỐ 2: BẢN GIAO HƯỞNG MÙA THU VỀ KHỞI NGHIỆP!</Link></li>
                            <li class="mb-3"><Link to="#" class="text-dark text-decoration-none" style={{textTransform: 'uppercase'}}>DẤU ẤN CNTT BÁCH KHOA TRONG 15 MÙA NHÂN TÀI ĐẤT VIỆT</Link></li>
                        </ul>
