...
function Footer(){
 return (
    <div class="container-fluid  text-white" style={{backgroundColor: 'gray'}}>
    <div class="row pt-5 mx-5">
        ...
        <div class="col-md-3 text-start">
            <p class="fs-6 fw-bold border-bottom pb-2 mb-2" style={{textTransform:'uppercase'}}>CHƯƠNG TRÌNH ĐẠO TẠO</p>
            <ul class="list-unstyled">
        ...
        <div class="col-md-3 text-start">
            <img src={require("../img/logo_footer.png")} />
